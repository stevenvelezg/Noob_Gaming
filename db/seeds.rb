...
Gun.create([
  ...
  {name: "C8-SFW", damage: 38, damage_supp: 32, rate_of_fire: 837, mobility: 50, mag_size: 30, max_ammo_pvp: 181, max_ammo_th: 301, organization: "JTF2", underbarrel: "Laser", barrel: ["Suppresor", "Muzzle Break", "Compensator", "Flash Hider", "Extended Barrel"], sights: ["ACOG", "Holograpic", "Reflex", "Red Dot"], weapon_type: "Assault Rifle"},
