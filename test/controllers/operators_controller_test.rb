...
class OperatorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create operator" do
    assert_difference('Operator.count') do
      post operators_url, params: { operator: { kda: @operator.kda, pick_rate: @operator.pick_rate, win_rate: @operator.win_rate } }
    end
  ...
  test "should update operator" do
    patch operator_url(@operator), params: { operator: { kda: @operator.kda, pick_rate: @operator.pick_rate, win_rate: @operator.win_rate } }
