class GunsController < ApplicationController
  ...
  def organization_search
    @guns = Gun.where( organization: params[:organization] )
    render template: 'guns/index'
  end

  def type_search
    @guns = Gun.where( weapon_type: params[:weapon_type] )
    render template: 'guns/index'
  end
  ...
  private
    ...
    def gun_params
      params.require(:gun).permit(:damage, :damage_supp, :rate_of_fire, :mobility, :mag_size, :max_ammo_pvp, :max_ammo_th)
    end
end
